...
on it. Inside: :mod:`~mm_companion.ui.settings.general_page`, the preferences that
belong to no other page; :mod:`~mm_companion.ui.settings.theme_page`, built on the
generated token form in :mod:`~mm_companion.ui.settings.token_editor`; and
...
__all__ = ["PAGES", "GMPage", "GeneralPage", "SettingsWindow"]
